...
const DOM = { 
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        if (transaction.description.length > 20){
            ...
            <td>
                <img onclick="Transaction.remove(${index})" src="./img/lixeira.png" width='27'" alt="remover transação">
            </td>
            `
...
const Utils = {
    formatAmount(value) {
        // Se houver pelo menos uma vírgula, tratamos a última como separador decimal
        if (value.indexOf(",") > -1) {
            const parts = value.split(",");
            // Pega a última parte como decimal e une as demais sem separador
